...
"ali2023masked": "Ali AM, Tirel L. Action masked deep reinforcement learning for controlling industrial assembly lines. In: 2023 IEEE World AI IoT Congress (AIIoT); 2023. doi:10.1109/AIIoT58121.2023.10174426.",
"alrashdan2026breakdowns": "Alrashdan KR. Routing under machine breakdowns: a benchmark of dispatching rules, bandits, and reinforcement learning for multi-server flow shops. J King Saud Univ Eng Sci. 2026;38:55. doi:10.1007/s44444-026-00128-9.",
"altman1999cmdp": "Altman E. Constrained Markov decision processes. Boca Raton (FL): Chapman & Hall/CRC; 1999.",
"babor2022bakery": "Babor M, Hitzmann B. Small and medium-sized bakery production data for scheduling. Version 2 [dataset]. Mendeley Data; 2022. doi:10.17632/dhgbssb8ns.2.",
...
"flexflowsimcppo": "Alrashdan KR. FlexFlowSim-CPPO: simulator, protocol documents and archived results [software]. GitHub; 2026. Available from: https://github.com/alrashdank/flexflowsim-cppo",
...
"paternain2019duality": "Paternain S, Chamon LFO, Calvo-Fullana M, Ribeiro A. Constrained reinforcement learning has zero duality gap. In: Advances in Neural Information Processing Systems 32; 2019.",
...
"rinciog2021fabricatio": "Rinciog A, Meyer A. Fabricatio-RL: a reinforcement learning simulation framework for production scheduling. In: Proceedings of the 2021 Winter Simulation Conference; 2021. doi:10.1109/WSC52266.2021.9715366.",
...
"tang2020mask": "Tang C-Y, Liu C-H, Chen W-K, You SD. Implementing action mask in proximal policy optimization (PPO) algorithm. ICT Express. 2020;6(3):200–203. doi:10.1016/j.icte.2020.05.003.",
...
for num, fname, cap in figs:
    out.append(f"**Figure {num}.** {cap} (file: {fname}.tif)\n")
