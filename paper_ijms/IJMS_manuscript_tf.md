...
in production systems. Two recent systematic reviews [1,2] report the same weaknesses across roughly two hundred
...
Optimization (PPO) [3] on two multi-server flow-shop testbeds,
...
trained with PPO [5,6,7,8]. An alternative to soft penalties is action masking
[9,10,11], which presupposes infeasible
...
[12,13,14]. On
benchmarking itself, Doherty and colleagues [15] reproduce five
...
[4] and [16], whose breakdown extensions are
...
exponentially smoothed slack [22] — on both testbeds and every
