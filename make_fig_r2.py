...
a1.set_xlabel("training steps (millions)"); a1.set_ylabel("λ_T (reward units per unit throughput)")
...
a2.axhline(0, color="#8a8a85", lw=0.8); a2.text(1.62, 0, "T_min", va="center", ha="left", fontsize=7.5, color="#5c5c58")
...
a2.set_xlabel("training steps (millions)"); a2.set_ylabel("TP − T_min per training episode\n(50-episode moving average)")
